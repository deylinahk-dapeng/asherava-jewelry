...
if ( ! $material ) {
	$material = __( 'Crafted from 925 sterling silver. Product-specific width, length, and approximate weight details are shown above when available.', 'asherava-jaxxon' );
}
...
if ( ! $care ) {
	...
	$care     = __( 'Store your chain dry, avoid harsh chemicals, and polish gently with a soft silver cloth when needed.', 'asherava-jaxxon' );
	if ( $care_url ) {
